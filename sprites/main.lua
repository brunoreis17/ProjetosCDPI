...
local bg = display.newImageRect ("bg.jpg", 626/1.5, 483/1.5)
bg.x = display.contentCenterX
bg.y = display.contentCenterY

-- Incluso de sprite animaçao

local sprite1 = graphics.newImageSheet ("playerFem2.png", {width=192, height=256, numFrames=45})
...
local sprite1Animacao = {
    ...
    {name="pulando", start=2, count=3, time=1000, loopCount=0}
}
...
local sprite2 = graphics.newImageSheet ("button.png", spriteOpcoes)
